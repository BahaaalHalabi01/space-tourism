...
<main class="px-6 container relative pt-12">
	<section class="flex flex-col text-center gap-y-24">
		<div class="space-y-7">
			<h2 class="uppercase font-normal font-sans-condensed text-text-light">
				So, you want to travel to
			</h2>
			<h1 class="uppercase text-[80px] font-serif leading-none">Space</h1>
			<h3 class="text-[15px] w-80 px-6 leading-[25px] text-text-light">
